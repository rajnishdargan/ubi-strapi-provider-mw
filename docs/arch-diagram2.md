...
The UBI Provider system enables providers to manage benefit applications through Network protocol. It consists of three main parts:
...
sequenceDiagram
    ...
    participant CMS as Strapi CMS
    participant Network as UBI / ONEST Network
...
graph LR
    ...
    subgraph "Data Sources"
        ...
        Network[UBI / ONEST Network<br/>Status Updates]
        style DB fill:#e8f5e9,stroke:#2e7d32
